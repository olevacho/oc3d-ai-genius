    ...
    class Oc3dAig_AdminController extends Oc3dAig_BaseController {
        ...
        public function __construct() {
            ...
            if (!class_exists('Oc3dAig_AdminChatBotController')) {
                $contr_path = OC3DAIG_PATH . "/lib/controllers/AdminChatBotController.php";
                include_once $contr_path;
            }
            $this->chatbot_controller = new Oc3dAig_AdminChatBotController();
        ...
        function enqueueStyles() {
            ...
            if (in_array($screen->id, $selected_p_types) || strpos($screen->id, 'oc3daig_settings') !== false || strpos($screen->id, 'oc3daig_image')  !== false  || strpos($screen->id, 'oc3daig_chatbot')  !== false) {
                wp_enqueue_style(
                        'jquery-ui',
        ...
        public function registerAdminMenu() {
            ...
            add_submenu_page(self::ADMIN_MENU, __('Chatbot', 'oc3d-ai-aiassistant'), 
                __('Chatbot', 'oc3d-ai-aiassistant'), 'edit_posts',
               OC3DAIG_PREFIX_LOW . 'chatbot', [$this->chatbot_controller, 'showMainView']);
