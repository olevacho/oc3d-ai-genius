...
<div id="oc3daig-tabs-1" class="oc3daig_tab_panel" data-oc3daig="1">
    ...
    <p class="oc3daig_instruction"><b>1.</b><?php esc_html_e('Input text into "Text to be changed" field.', 'oc3d-ai-genius'); ?>
        ...
        <b>3.</b><?php esc_html_e('Select other parameters (optionally). ', 'oc3d-ai-genius'); ?>
    ...
    <div class="oc3daig_form_row">
        ...
        ?>
                    ...
                    <td id="newmetaleft" class="oc3daig_td">
                        ...
                        <input class="oc3daig_input oc3daig_select_ch" id="oc3daig_max_tokens_c" name="oc3daig_max_tokens_c" type="number" step="1"  value="<?php echo (int)$mx_tokens; ?>" maxlength="3" autocomplete="off" >
                        ...
                        <div class="tablenav-pages">
                            ...
                            if ($display_pagination) {
                                ...
                                <div class="oc3daig_pagination">
                                    ...
                                    echo '<span class="oc3daig_total_instructions" style="padding-left:20px;"> ';
                                    printf(esc_html__( 'Total: %s items', 'oc3d-ai-genius' ),esc_html($total_instructions));
                                    echo '';
                                    ?>    
                                </div>
                                <?php
                            ...
                            <p class="search-box">
                                ...
                                <input type="text" id="oc3daig_search" name="oc3daig_search" value="<?php echo esc_html($search_string); ?>" onkeyup="oc3daigMetaSearchKeyUp(event);" >
                        ...
                        <table id="oc3daig_instructions" class="wp-list-table widefat fixed striped pages">
                            ...
                            <tbody id="oc3daig-the-list">
                                ...
                                foreach ($instructions as $row) {
                                    ...
                                    ?>
                                    <tr class="<?php echo esc_attr($oc3daig_disabled_text); ?>">
                                        <td class="id_column">
                                            <?php
                                            $displayed_id = $row_id;
                                            ?>
                                            <a href="<?php echo '#'; ?>" onclick="oc3daigMetaSelectInstruction(event,<?php echo esc_html($row_id); ?>)" >
                                                <?php
                                        ...
                                        <?php ?> 
                                        <td>
                                            <a href="<?php echo '#'; ?>" onclick="oc3daigMetaSelectInstruction(event,<?php echo esc_html($row_id); ?>)" id="oc3daig_instr_href_<?php echo esc_html($row_id); ?>">
                                                <?php
